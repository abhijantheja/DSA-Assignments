...
void test_black_height(Lexicon *lexicon)
{
    ...
    // cout << "before deleting " << lexicon->getRedBlackTree().isBlackHeightBalanced(lexicon->getRedBlackTree().getRoot()) << endl;
    // for (int i = 0; i < 119; i++)
    // {
    //     cout << "deleting" << lexicon->getRedBlackTree().getRoot()->key << endl;
    //     lexicon->getRedBlackTree().deleteNode(lexicon->getRedBlackTree().getRoot()->key);
    //     cout << "after deletion  " << lexicon->getRedBlackTree().isBlackHeightBalanced(lexicon->getRedBlackTree().getRoot()) << endl;
    // }
 cout << lexicon->getRedBlackTree().getTotalNodes(lexicon->getRedBlackTree().getRoot()) << endl;
